...
def main(args):
    ...
    test_data = dataset["test"].select(range(min(args.num_samples, len(dataset["test"]))))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-id", default="google/flan-t5-base", help="Base model ID")
    parser.add_argument("--peft-weights", help="Path to LoRA weights")
    parser.add_argument("--num-samples", default=100, type=int, help="Number of test samples")
