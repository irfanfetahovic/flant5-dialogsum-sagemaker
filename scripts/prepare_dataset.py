...
if __name__ == "__main__":
    ...
    parser.add_argument("--train-size", default=125, type=int, help="Number of training examples")
    parser.add_argument("--val-size", default=32, type=int, help="Number of validation examples")
